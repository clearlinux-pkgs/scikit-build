...
Version  : 0.9.0
Release  : 22
URL      : https://github.com/scikit-build/scikit-build/archive/0.9.0.tar.gz
Source0  : https://github.com/scikit-build/scikit-build/archive/0.9.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552069144
