...
Source0  : https://github.com/scikit-build/scikit-build/archive/0.11.0/scikit-build-0.11.0.tar.gz
...
%prep
%setup -q -n scikit-build-0.11.0
cd %{_builddir}/scikit-build-0.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588306599
...
cp %{_builddir}/scikit-build-0.11.0/LICENSE %{buildroot}/usr/share/package-licenses/scikit-build/48d9b98c9f043b5a42399020beaac0aa6afbc4b3
